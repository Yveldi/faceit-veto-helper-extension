// Real FACEIT skill-level icons (1-10), ported verbatim from the web app
// (Faceit-Veto-Helper/src/components/FaceitLevel), which renders them reliably.
// Self-contained: solid fills, NO gradient/mask ids, so rendering all 10 on a
// page can't collide. `level` comes straight from the roster's gameSkillLevel.
//
// Challenger (top-ranked level 10) is a separate emblem; we don't have the
// leaderboard data to detect it (gameSkillLevel maxes at 10, no rank in the
// match payload), so it's available via `challenger` but never set for now.

const CHALLENGER = (size) => (
  <svg
    viewBox="0 0 24 24"
    fill="#e80128"
...
// The colored arc + baked number, one per level. `s` = pixel size.
const LEVELS = {
  1: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.685 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.563-1.823z" clipRule="evenodd" />
      <path fill="#EEE" fillRule="evenodd" d="M5.894 15.816 3.858 17.09a9.656 9.656 0 0 0 1.894 2.2l1.562-1.822a7.206 7.206 0 0 1-1.42-1.65z" clipRule="evenodd" />
      <path fill="#EEE" d="m11.765 10.233-1.487.824v-1.034L12 8.948h.991V14.4h-1.226v-4.167z" />
    </svg>
  ),
  2: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.685 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.563-1.823z" clipRule="evenodd" />
      <path fill="#1CE400" fillRule="evenodd" d="m5.257 14.53-2.249.842a9.613 9.613 0 0 0 2.743 3.917l1.563-1.822a7.206 7.206 0 0 1-2.057-2.938z" clipRule="evenodd" />
      <path fill="#1CE400" d="M10.05 13.157c0-.303.084-.566.252-.79a1.6 1.6 0 0 1 .655-.512 8.17 8.17 0 0 1 .748-.286 2.78 2.78 0 0 0 .663-.302c.157-.107.235-.233.235-.378v-.698c0-.173-.07-.288-.21-.344-.15-.062-.386-.092-.705-.092-.387 0-.896.07-1.529.21V9.04a8.523 8.523 0 0 1 1.756-.177c.66 0 1.15.101 1.47.303.324.201.487.537.487 1.008v.756c0 .285-.087.534-.26.747a1.567 1.567 0 0 1-.656.47c-.252.107-.51.202-.773.286a2.65 2.65 0 0 0-.68.336c-.162.123-.244.27-.244.437v.277h2.621v.916h-3.83v-1.243z" />
    </svg>
  ),
  3: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.686 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.562-1.823z" clipRule="evenodd" />
      <path fill="#1CE400" fillRule="evenodd" d="M2.4 12a9.58 9.58 0 0 0 3.352 7.29l1.562-1.823A7.184 7.184 0 0 1 4.801 12H2.4z" clipRule="evenodd" />
      <path fill="#1CE400" d="M11.79 14.484c-.47 0-1.08-.042-1.831-.126v-.975l.269.05c.106.023.165.037.176.043l.286.05c.067.011.21.028.428.05.168.017.339.026.513.026.324 0 .548-.04.672-.118.128-.078.193-.227.193-.445v-.63c0-.263-.283-.395-.849-.395h-.99v-.84h.99c.437 0 .656-.16.656-.479v-.529a.453.453 0 0 0-.068-.269c-.044-.067-.126-.114-.243-.142a2.239 2.239 0 0 0-.504-.042c-.32 0-.812.033-1.479.1V8.94c.762-.05 1.3-.076 1.613-.076.683 0 1.176.079 1.479.235.308.157.462.434.462.832v.899a.62.62 0 0 1-.152.42.703.703 0 0 1-.37.227c.494.173.74.445.74.814v.89c0 .466-.16.799-.479 1-.319.202-.823.303-1.512.303z" />
    </svg>
  ),
  4: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.686 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.562-1.823z" clipRule="evenodd" />
      <path fill="#FFC800" fillRule="evenodd" d="M6.91 6.91 5.211 5.211A9.57 9.57 0 0 0 2.4 12a9.58 9.58 0 0 0 3.352 7.289l1.562-1.822A7.184 7.184 0 0 1 4.801 12c0-1.988.805-3.788 2.108-5.09z" clipRule="evenodd" />
      <path fill="#FFC800" d="M12.303 13.3h-2.52v-.967l2.243-3.385h1.386v3.47H14v.881h-.588v1.1h-1.109v-1.1zm0-.883v-2.31l-1.47 2.31h1.47z" />
    </svg>
  ),
  5: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.686 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.562-1.823z" clipRule="evenodd" />
      <path fill="#FFC800" fillRule="evenodd" d="M12 2.4A9.6 9.6 0 0 0 2.4 12a9.58 9.58 0 0 0 3.352 7.29l1.562-1.823A7.2 7.2 0 0 1 12 4.8V2.4z" clipRule="evenodd" />
  ...
  6: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.686 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.562-1.823z" clipRule="evenodd" />
      <path fill="#FFC800" fillRule="evenodd" d="M15.816 5.895a7.2 7.2 0 0 0-8.502 11.572l-1.562 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4c1.87 0 3.613.535 5.089 1.458l-1.273 2.037z" clipRule="evenodd" />
  ...
  7: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
      <circle cx="12" cy="12" r="12" fill="#1F1F22" />
      <path fill="#CDCDCD" fillOpacity="0.1" fillRule="evenodd" d="M16.686 17.467a7.2 7.2 0 1 0-9.371 0l-1.563 1.822A9.58 9.58 0 0 1 2.4 12 9.6 9.6 0 0 1 12 2.4a9.6 9.6 0 0 1 9.6 9.6 9.58 9.58 0 0 1-3.352 7.29l-1.562-1.823z" clipRule="evenodd" />
      <path fill="#FFC800" fillRule="evenodd" d="M17.934 7.92a7.2 7.2 0 1 0-10.62 9.546L5.752 19.29A9.58 9.58 0 0 1 2.4 12a9.6 9.6 0 0 1 17.512-5.44l-1.978 1.36z" clipRule="evenodd" />
      <path fill="#FFC800" d="M12.546 9.906H9.9v-.958h4v.84L11.807 14.4h-1.36l2.1-4.494z" />
    </svg>
  ),
  8: (s) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width={s} height={s}>
